...
router.get('/', function (req, res) { 
    res.render('index', { title: 'Earring App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'Earring App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'Earring App Login', user : req.user }); 
}); 
